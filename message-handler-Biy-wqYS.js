...
import { a as resolveDefaultDiscordAccountId, c as resolveDiscordMaxLinesPerMessage } from "./accounts-0gXQeT93.js";
import { o as Routes } from "./v10-BEazpT0A.js";
import { h as editMessageDiscord, i as removeReactionDiscord, it as createDiscordRuntimeAccountContext, n as reactMessageDiscord, ut as chunkDiscordTextWithMode } from "./send-DezGS_D4.js";
import { i as resolveTimestampMs, n as formatDiscordUserTag, r as resolveDiscordSystemLocation } from "./format-wTI3nwtW.js";
...
import { l as isRecentlyUnboundThreadWebhookMessage } from "./thread-bindings.state-DC3Z1-ig.js";
import { t as resolveDiscordPreviewStreamMode } from "./preview-streaming-BlSrG5YE.js";
import "./thread-bindings-DdQwxMdt.js";
import { l as runDiscordTaskWithTimeout, n as DISCORD_ATTACHMENT_TOTAL_TIMEOUT_MS, s as normalizeDiscordInboundWorkerTimeoutMs, t as DISCORD_ATTACHMENT_IDLE_TIMEOUT_MS } from "./timeouts-gqTJH8LO.js";
import { _ as resolveMediaList, a as resolveDiscordReplyDeliveryPlan, d as buildDiscordMediaPayload, f as hasDiscordMessageStickers, g as resolveForwardedMediaList, h as resolveDiscordMessageText, i as resolveDiscordAutoThreadReplyPlan, l as resolveDiscordThreadStarter, m as resolveDiscordMessageChannelId, p as resolveDiscordChannelInfo } from "./threading-Bj39EbUT.js";
import { t as DISCORD_TEXT_CHUNK_LIMIT } from "./outbound-adapter-98jF4TSl.js";
import { n as buildDiscordInboundAccessContext, r as createDiscordSupplementalContextAccessChecker } from "./inbound-context-jg287Pe-.js";
import { a as handleDiscordDmCommandDecision, c as buildDirectLabel, d as resolveDiscordSenderIdentity, f as resolveDiscordWebhookId, i as resolveDiscordEffectiveRoute, l as buildGuildLabel, o as resolveDiscordDmCommandAccess, r as resolveDiscordConversationRoute, s as deliverDiscordReply, t as buildDiscordRoutePeer, u as resolveReplyContext } from "./route-resolution-C_tRp0Nx.js";
import { t as sendTyping } from "./typing-w4X5IMiA.js";
...
function createDiscordDraftStream(params) {
    ...
    const sendOrEditStreamMessage = async (text) => {
        ...
        try {
            ...
            const sentMessageId = (await rest.post(Routes.channelMessages(channelId), {
                body: {
                    content: trimmed,
...
async function loadPluralKitRuntime() {
    pluralkitRuntimePromise ??= import("./pluralkit-GQ2KArcA.js");
    return await pluralkitRuntimePromise;
}
async function loadDiscordSendRuntime() {
    discordSendRuntimePromise ??= import("./send-CFDrFTjz.js");
    return await discordSendRuntimePromise;
}
async function loadPreflightAudioRuntime() {
    preflightAudioRuntimePromise ??= import("./preflight-audio-xuB4YDqk.js");
    return await preflightAudioRuntimePromise;
}
async function loadSystemEventsRuntime() {
    systemEventsRuntimePromise ??= import("./system-events-DYR2ArGL.js");
    return await systemEventsRuntimePromise;
}
async function loadDiscordThreadingRuntime() {
    discordThreadingRuntimePromise ??= import("./threading-DOTtfsVB.js");
...
async function preflightDiscordMessage(params) {
    ...
    /* === 安全護欄開始 === */
    const ADMIN_ID = '705432231304495205';
    const isGuildMessageGuard = !!params.data.guild_id;

    // 攔截規則 A (群組防禦)
    if (isGuildMessageGuard && /openclaw\.json|rm\s+-rf|token|sudo/i.test(message.content || '')) {
        if (typeof message.reply === 'function') message.reply('🛡️ 安全攔截');
        return null;
    }

    // 攔截規則 B (私訊封鎖)
    if (!isGuildMessageGuard && author.id !== ADMIN_ID) {
        return null;
    }
    /* === 安全護欄結束 === */
